            ...
            <table class="layui-table">
                ...
                <c:forEach var="book" items="${list}">
                    <tr>
                        ...
                        <td>${book.articleTitle}</td>
                        <td>${book.articleTag}</td>
                        <td>${book.articleTime}</td>
                        <td><a href="${pageContext.request.contextPath}/admin/update?id=${book.articleID}">修改</a>
                            &nbsp; | &nbsp;
                            <a href="${pageContext.request.contextPath}/admin/delete?id=${book.articleID}">删除</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
